  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="d-none d-lg-block col-lg-2 position-relative">
        <div class="bg-secondary rounded text-white d-flex justify-content-center align-items-center"
             style="width: 150px; height: 100px; position: absolute; top: 52px; left: 34px;">
        ...
        <div class="position-relative" style="top: -14px; margin-left: 40px;">
          <div class="d-flex justify-content-between">
            <div class="position-relative">
              <span class="position-absolute bg-white" style="white-space: nowrap; z-index: 100;">
                Flyers settings 1
              </span>
            </div>
          </div>
        ...
        <form @submit.prevent="saveDetails">
          ...
          <div class="card-body m-3 pb-5">
            <div class="row g-3">
              ...
              <div class="col-md-6 col-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.paperType"
                           name="paperType" value="silkMatt" id="silkMatt"/>
                    <label class="form-check-label" for="silkMatt">Silk (Matt finish)</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.paperType"
              ...
              <div class="col-md-6 col-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input v-model="productDetails.design.orientation" class="form-check-input" type="radio"
              ...
              <div class="col-md-6 col-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.paperThickness"
                           name="paperThickness" value="130 gsm" id="gsm130"/>
                    <label class="form-check-label" for="gsm130">130 GSM</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.paperThickness"
                           name="paperThickness" value="170 gsm" id="gsm170"/>
              ...
              <div class="col-md-6 col-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.finishedSize"
                           name="finishedSize" value="A7" id="A7"/>
                    <label class="form-check-label" for="A7">A7</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.finishedSize"
                           name="finishedSize" value="A6" id="a6Size"/>
                    <label class="form-check-label" for="a6Size">A6</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" v-model="productDetails.design.finishedSize"
                           name="finishedSize" value="A5" id="a5Size"/>
            ...
            <div class="form-group mt-4">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" id="yes" value="1" v-model="productDetails.hasDesignFile"/>
                <label class="form-check-label" for="yes">Yes</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" id="no" value="0" v-model="productDetails.hasDesignFile"/>
      ...
      <!-- Pricing Component (displayed on larger screens only) -->
